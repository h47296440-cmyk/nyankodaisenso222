...
export const ENEMY_DEFINITIONS: Record<string, EnemyDefinition> = {
  ...
  // =========================================================================
  // MANIC BOSSES (大狂乱降臨ボス 極ムズキャラクター)
  // =========================================================================
  enemy_manic_cat: {
    id: 'enemy_manic_cat',
    name: '大狂乱のネコモヒカン（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ】神速の足で突進してくる大狂乱ボス！狂乱を遥かに凌ぐ超火力と圧倒的速度で前線を粉砕する！',
    hp: 650000,
    attackPower: 4800,
    attackRange: 120,
    attackSpeed: 1.8,
  ...
  enemy_manic_tank: {
    id: 'enemy_manic_tank',
    name: '大狂乱のゴムネコ（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ / 超要塞耐久】脅威の超耐久と一撃即死級の攻撃力！壁を何枚も敷き詰め、遠距離アタッカーで削り続けろ！',
    hp: 1200000,
    attackPower: 8500,
    attackRange: 150,
    attackSpeed: 0.6,
  ...
  enemy_manic_axe: {
    id: 'enemy_manic_axe',
    name: '大狂乱の暗黒ネコ（降臨ボス）',
    description: '【大狂乱降臨BOSS / 赤い敵 / 極ムズ】漆黒の大剣を高速連打する暗黒戦士！赤い敵対策キャラと長射程キャラで迎え撃て！',
    hp: 800000,
    attackPower: 5800,
    attackRange: 140,
    attackSpeed: 1.9,
  ...
  enemy_manic_gross: {
    id: 'enemy_manic_gross',
    name: '大狂乱のムキあしネコ（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ / Lv4確定波動】確定Lv4波動を連発する大狂乱の美脚！波動ストッパーや高体力キャラで突破せよ！',
    hp: 550000,
    attackPower: 4500,
    attackRange: 240,
    attackSpeed: 1.0,
  ...
  enemy_manic_cow: {
    id: 'enemy_manic_cow',
    name: '大狂乱のライオン（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ / 超神速大群】超音速で押し寄せる大狂乱ライオン！範囲超火力で前線を死守せよ！',
    hp: 320000,
    attackPower: 2600,
    attackRange: 100,
    attackSpeed: 4.0,
  ...
  enemy_manic_bird: {
    id: 'enemy_manic_bird',
    name: '大狂乱の天空のネコ（降臨ボス）',
    description: '【大狂乱降臨BOSS / 浮いてる敵 / 極ムズ】天空から超絶破壊レーザーを降らせる巨大空母！浮いてる敵妨害が攻略のカギ！',
    hp: 750000,
    attackPower: 7800,
    attackRange: 260,
    attackSpeed: 0.9,
  ...
  enemy_manic_fish: {
    id: 'enemy_manic_fish',
    name: '大狂乱のネコ島（降臨ボス）',
    description: '【大狂乱降臨BOSS / 赤い敵 / 極ムズ / 確定クリティカル】火山島と化した凶悪魚！超強力クリティカルで味方を粉砕する！',
    hp: 680000,
    attackPower: 8200,
    attackRange: 150,
    attackSpeed: 1.3,
  ...
  enemy_manic_lizard: {
    id: 'enemy_manic_lizard',
    name: '大狂乱のネコキングドラゴン（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ / 超長射程メガレーザー】射程450から放たれるメガ火炎弾！重なる前に足の速いキャラで突撃せよ！',
    hp: 600000,
    attackPower: 9800,
    attackRange: 450,
    attackSpeed: 0.75,
  ...
  enemy_manic_titan: {
    id: 'enemy_manic_titan',
    name: '大狂乱のネコジャラミ（降臨ボス）',
    description: '【大狂乱降臨BOSS / 極ムズ / Lv5破滅波動＆ふっとばし】邪神の鉄拳！高確率でLv5波動を放ち前線を壊滅させる最強の大狂乱ボス！',
    hp: 1350000,
    attackPower: 9500,
    attackRange: 170,
    attackSpeed: 0.55,
  ...
  // =========================================================================
  // 追加属性・特殊ステージ用敵ユニット完全定義
  // =========================================================================
  enemy_alien_snache: {
    id: 'enemy_alien_snache',
    name: 'エイリアンにょろ',
    description: '青く輝くエイリアン化したにょろ。すばやい連続攻撃を繰り出す。',
    hp: 450,
    attackPower: 120,
    attackRange: 60,
    attackSpeed: 1.6,
  ...
  enemy_alien_hippoe: {
    id: 'enemy_alien_hippoe',
    name: 'カバタリアン',
    description: 'エイリアンとなったカバちゃん。高い耐久力で前線を支える。',
    hp: 4200,
    attackPower: 450,
    attackRange: 80,
    attackSpeed: 0.8,
  ...
  enemy_alien_penguin: {
    id: 'enemy_alien_penguin',
    name: 'スペースペンギン',
    description: '宇宙の力を手に入れたペンギン。鋭いくちばし攻撃が脅威。',
    hp: 2200,
    attackPower: 580,
    attackRange: 120,
    attackSpeed: 1.4,
    ...
    rewardXp: 350,
    traits: ['alien'],
    spriteType: 'enemy_alien_space_peng',
    scale: 1.1,
  },
  enemy_zombie_seal: {
    id: 'enemy_zombie_seal',
    name: 'アンデッド・アザラシ',
    description: 'ゾンビ化したゴマさま。一度倒れても蘇生して進軍してくる。',
    hp: 5500,
    attackPower: 700,
    attackRange: 90,
    attackSpeed: 1.0,
    ...
    scale: 1.2,
    abilities: {
      revive: { count: 1, delaySeconds: 3.5, hpPercent: 100 },
      burrow: { count: 1, distance: 300 },
    },
  },
  enemy_assassin_bear: {
    id: 'enemy_assassin_bear',
    name: 'ブラッククマ先生',
    description: '闇の力に目覚めた暗殺クマ。超高速移動と超絶威力の爪撃で拠点を破壊する。',
    hp: 1200,
    attackPower: 9999,
    attackRange: 140,
    attackSpeed: 2.0,
  ...
  enemy_angel_doge: {
    id: 'enemy_angel_doge',
    name: '天使ガブリエル',
    description: '光り輝く輪を頭に載せた天使わんこ。素早いステップで前線を押し上げる。',
    hp: 950,
    attackPower: 260,
    attackRange: 70,
    attackSpeed: 1.5,
  ...
  enemy_angel_gorilla: {
    id: 'enemy_angel_gorilla',
    name: '天使ゴリさん',
    description: '聖なる光を纏う天使ゴリラ。圧倒的な怒涛のラッシュで戦線を粉砕する。',
    hp: 8500,
    attackPower: 1100,
    attackRange: 100,
    attackSpeed: 1.8,
  ...
  enemy_angel_sleipnir: {
    id: 'enemy_angel_sleipnir',
    name: '天使スレイプニール',
    description: '神聖なる白馬の天使。長大な射程からの連続突進で相手を寄せ付けない。',
    hp: 24000,
    attackPower: 2200,
    attackRange: 340,
    attackSpeed: 1.2,
  ...
  enemy_star_penguin: {
    id: 'enemy_star_penguin',
    name: 'スターペンシルバニア',
    description: '宇宙のスターエイリアンペンギン。強力なスターバリアを展開してにゃんこを阻む。',
    hp: 8800,
    attackPower: 1400,
    attackRange: 130,
    attackSpeed: 1.4,
    ...
    abilities: {
      barrier: { hp: 4000 },
      warp: { chance: 0.3, distance: 150 },
    },
  },
  enemy_star_elephant: {
    id: 'enemy_star_elephant',
    name: 'スター・エレファント',
    description: '強固なスターバリアに守られた超巨大ゾウ。遠距離から破壊的な衝撃波を放つ。',
    hp: 45000,
    attackPower: 3800,
    attackRange: 360,
    attackSpeed: 0.6,
  ...
  enemy_star_alien_face: {
    id: 'enemy_star_alien_face',
    name: 'スター・フェイス',
    description: '宇宙空間を漂う巨大な顔面スターエイリアン。超高耐久とバリアで立ちはだかる。',
    hp: 80000,
    attackPower: 4500,
    attackRange: 200,
    attackSpeed: 0.5,
    ...
    rewardMoney: 8000,
    rewardXp: 6000,
    traits: ['alien', 'star_alien', 'floating'],
    spriteType: 'enemy_cosmos_god',
    scale: 2.0,
    abilities: {
      barrier: { hp: 15000 },
  ...
  enemy_red_seal: {
    id: 'enemy_red_seal',
    name: 'ゴマさま (赤)',
    description: '真っ赤に熟したアザラシ。高い体力と安定した攻撃力を持つ。',
    hp: 2200,
    attackPower: 320,
    attackRange: 80,
    attackSpeed: 1.1,
  ...
  enemy_shadow_boxer: {
    id: 'enemy_shadow_boxer',
    name: 'シャドウボクサー',
    description: '漆黒の拳を持つボクサーカンガルー。猛烈な超高速連打で前線を圧倒する。',
    hp: 12000,
    attackPower: 1600,
    attackRange: 110,
    attackSpeed: 2.2,
  ...
  enemy_red_snake: {
    id: 'enemy_red_snake',
    name: '赤ヘビ',
    description: '赤い色素が濃くなった狂暴なヘビ。手数が多い。',
    hp: 350,
    attackPower: 80,
    attackRange: 55,
    attackSpeed: 1.8,
  ...
  enemy_red_bore: {
    id: 'enemy_red_bore',
    name: '赤羅我王・猛突イノシシ',
    description: '激怒した赤いイノシシ。凄まじい突進力と攻撃頻度で押し切る。',
    hp: 36000,
    attackPower: 3200,
    attackRange: 100,
    attackSpeed: 2.0,
  ...
  enemy_black_doge: {
    id: 'enemy_black_doge',
    name: '殺意のわんこ',
    description: '黒いオーラを放つ危険なわんこ。高スピードで一気に詰め寄る。',
    hp: 1800,
    attackPower: 450,
    attackRange: 65,
    attackSpeed: 1.6,
  ...
  enemy_alien_kangaroo: {
    id: 'enemy_alien_kangaroo',
    name: 'エイリアンカンガルー',
    description: '宇宙エネルギーでジャンプ力を強化したカンガルー。',
    hp: 9500,
    attackPower: 1250,
    attackRange: 110,
    attackSpeed: 1.8,
  ...
  enemy_bunbun_black: {
    id: 'enemy_bunbun_black',
    name: 'ブラックブンブン先生',
    description: '漆黒の教師魂。休むことなき怒涛の連撃で全ての壁を破壊する。',
    hp: 95000,
    attackPower: 5800,
    attackRange: 150,
    attackSpeed: 2.2,
  ...
  enemy_crazed_basic: {
    id: 'enemy_crazed_basic',
    name: '狂乱のネコ (敵)',
    description: '狂乱化したにゃんこ。怒りに身を任せて前進する。',
    hp: 16000,
    attackPower: 1800,
    attackRange: 90,
    attackSpeed: 1.4,
